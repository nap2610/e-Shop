...
import { doSocialLogin } from "@/service/auth/authService";
              ...
              <form action={doSocialLogin}>
                ...
                <div className="flex flex-col gap-4.5 mt-4.5">
                  ...
                  >
                    ...
                    >
                      <path
                        d="M12 2C6.48 2 2 6.48 2 12c0 5.02 3.66 9.17 8.44 9.88v-7h-2.54v-2.88h2.54v-2.2c0-2.51 1.49-3.89 3.78-3.89 1.09 0 2.24.19 2.24.19v2.47h-1.26c-1.24 0-1.63.77-1.63 1.56v1.87h2.78l-.45 2.88h-2.33v7C18.34 21.17 22 17.02 22 12c0-5.52-4.48-10-10-10z"
                        fill="#1877F2"
                      />
                    </svg>
                  ...
                  >
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M12 2C6.48 2 2 6.48 2 12c0 4.42 2.87 8.17 6.84 9.5.5.09.66-.22.66-.48 0-.24-.01-.87-.01-1.7-2.78.61-3.37-1.34-3.37-1.34-.45-1.14-1.11-1.45-1.11-1.45-.91-.63.07-.62.07-.62 1 .07 1.53 1.02 1.53 1.02.89 1.53 2.34 1.09 2.91.83.09-.65.35-1.09.63-1.34-2.22-.25-4.56-1.11-4.56-4.95 0-1.09.39-1.98 1.02-2.68-.1-.25-.45-1.27.1-2.65 0 0 .84-.27 2.75 1.02a9.54 9.54 0 0 1 5 0c1.91-1.29 2.75-1.02 2.75-1.02.55 1.38.2 2.4.1 2.65.63.7 1.02 1.59 1.02 2.68 0 3.85-2.34 4.7-4.57 4.95.36.31.68.92.68 1.85 0 1.34-.01 2.42-.01 2.75 0 .27.17.58.68.48A10 10 0 0 0 22 12c0-5.52-4.48-10-10-10z"
                        fill="#000000"
                      />
                    </svg>
                    Sign In with Github
